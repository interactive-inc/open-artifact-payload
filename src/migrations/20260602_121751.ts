...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`home_page_services_items_order_idx\` ON \`home_page_services_items\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`home_page_services_items_parent_id_idx\` ON \`home_page_services_items\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_home_page_v_version_services_items_order_idx\` ON \`_home_page_v_version_services_items\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_home_page_v_version_services_items_parent_id_idx\` ON \`_home_page_v_version_services_items\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`about_mission_values_order_idx\` ON \`about_mission_values\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`about_mission_values_parent_id_idx\` ON \`about_mission_values\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`about_company_profile_rows_order_idx\` ON \`about_company_profile_rows\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`about_company_profile_rows_parent_id_idx\` ON \`about_company_profile_rows\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`about_members_items_order_idx\` ON \`about_members_items\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`about_members_items_parent_id_idx\` ON \`about_members_items\` (\`_parent_id\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`about_members_items_image_idx\` ON \`about_members_items\` (\`image_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_about_v_version_mission_values_order_idx\` ON \`_about_v_version_mission_values\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_about_v_version_mission_values_parent_id_idx\` ON \`_about_v_version_mission_values\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_about_v_version_company_profile_rows_order_idx\` ON \`_about_v_version_company_profile_rows\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_about_v_version_company_profile_rows_parent_id_idx\` ON \`_about_v_version_company_profile_rows\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_about_v_version_members_items_order_idx\` ON \`_about_v_version_members_items\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_about_v_version_members_items_parent_id_idx\` ON \`_about_v_version_members_items\` (\`_parent_id\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_about_v_version_members_items_image_idx\` ON \`_about_v_version_members_items\` (\`image_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_about_v_version_version__status_idx\` ON \`_about_v\` (\`version__status\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`service_services_items_features_order_idx\` ON \`service_services_items_features\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`service_services_items_features_parent_id_idx\` ON \`service_services_items_features\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`service_services_items_order_idx\` ON \`service_services_items\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`service_services_items_parent_id_idx\` ON \`service_services_items\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`service_process_steps_order_idx\` ON \`service_process_steps\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`service_process_steps_parent_id_idx\` ON \`service_process_steps\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_service_v_version_services_items_features_order_idx\` ON \`_service_v_version_services_items_features\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_service_v_version_services_items_features_parent_id_idx\` ON \`_service_v_version_services_items_features\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_service_v_version_services_items_order_idx\` ON \`_service_v_version_services_items\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_service_v_version_services_items_parent_id_idx\` ON \`_service_v_version_services_items\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_service_v_version_process_steps_order_idx\` ON \`_service_v_version_process_steps\` (\`_order\`);`,
  )
  await db.run(
    sql`CREATE INDEX \`_service_v_version_process_steps_parent_id_idx\` ON \`_service_v_version_process_steps\` (\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE INDEX \`_service_v_version_version__status_idx\` ON \`_service_v\` (\`version__status\`);`,
  )
  ...
  await db.run(
    sql`ALTER TABLE \`home_page\` ADD \`about_preview_image_id\` integer REFERENCES media(id);`,
  )
  ...
  await db.run(
    sql`ALTER TABLE \`_home_page_v\` ADD \`version_services_enabled\` integer DEFAULT true;`,
  )
  ...
  await db.run(
    sql`ALTER TABLE \`_home_page_v\` ADD \`version_about_preview_enabled\` integer DEFAULT true;`,
  )
  ...
  await db.run(
    sql`ALTER TABLE \`_home_page_v\` ADD \`version_about_preview_image_id\` integer REFERENCES media(id);`,
  )
