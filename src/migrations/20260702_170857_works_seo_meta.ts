...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_works\`("id", "title", "slug", "category", "published_at", "thumbnail_id", "summary", "body", "updated_at", "created_at", "_status") SELECT "id", "title", "slug", "category", "published_at", "thumbnail_id", "summary", "body", "updated_at", "created_at", "_status" FROM \`works\`;`)
