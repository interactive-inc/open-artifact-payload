...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(
    sql`CREATE UNIQUE INDEX \`news_locales_locale_parent_id_unique\` ON \`news_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  await db.run(
    sql`CREATE UNIQUE INDEX \`_news_v_locales_locale_parent_id_unique\` ON \`_news_v_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`faq_locales_locale_parent_id_unique\` ON \`faq_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  await db.run(
    sql`CREATE UNIQUE INDEX \`works_locales_locale_parent_id_unique\` ON \`works_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  await db.run(
    sql`CREATE UNIQUE INDEX \`_works_v_locales_locale_parent_id_unique\` ON \`_works_v_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`site_settings_header_nav_locales_locale_parent_id_unique\` ON \`site_settings_header_nav_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`site_settings_footer_nav_locales_locale_parent_id_unique\` ON \`site_settings_footer_nav_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`site_settings_policy_links_locales_locale_parent_id_unique\` ON \`site_settings_policy_links_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`home_page_services_items_locales_locale_parent_id_unique\` ON \`home_page_services_items_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  await db.run(
    sql`CREATE UNIQUE INDEX \`home_page_locales_locale_parent_id_unique\` ON \`home_page_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_home_page_v_version_services_items_locales_locale_parent_id\` ON \`_home_page_v_version_services_items_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  await db.run(
    sql`CREATE UNIQUE INDEX \`_home_page_v_locales_locale_parent_id_unique\` ON \`_home_page_v_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`about_mission_values_locales_locale_parent_id_unique\` ON \`about_mission_values_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`about_company_profile_rows_locales_locale_parent_id_unique\` ON \`about_company_profile_rows_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`about_members_items_locales_locale_parent_id_unique\` ON \`about_members_items_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`about_locales_locale_parent_id_unique\` ON \`about_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_about_v_version_mission_values_locales_locale_parent_id_uni\` ON \`_about_v_version_mission_values_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_about_v_version_company_profile_rows_locales_locale_parent_\` ON \`_about_v_version_company_profile_rows_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_about_v_version_members_items_locales_locale_parent_id_uniq\` ON \`_about_v_version_members_items_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_about_v_locales_locale_parent_id_unique\` ON \`_about_v_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`service_services_items_features_locales_locale_parent_id_uni\` ON \`service_services_items_features_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`service_services_items_locales_locale_parent_id_unique\` ON \`service_services_items_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`service_process_steps_locales_locale_parent_id_unique\` ON \`service_process_steps_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`service_locales_locale_parent_id_unique\` ON \`service_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_service_v_version_services_items_features_locales_locale_pa\` ON \`_service_v_version_services_items_features_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_service_v_version_services_items_locales_locale_parent_id_u\` ON \`_service_v_version_services_items_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_service_v_version_process_steps_locales_locale_parent_id_un\` ON \`_service_v_version_process_steps_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`CREATE UNIQUE INDEX \`_service_v_locales_locale_parent_id_unique\` ON \`_service_v_locales\` (\`_locale\`,\`_parent_id\`);`,
  )
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new_news\`("id", "slug", "published_at", "category", "thumbnail_id", "updated_at", "created_at", "_status") SELECT "id", "slug", "published_at", "category", "thumbnail_id", "updated_at", "created_at", "_status" FROM \`news\`;`,
  )
  ...
  await db.run(
    sql`CREATE INDEX \`_news_v_published_locale_idx\` ON \`_news_v\` (\`published_locale\`);`,
  )
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new_works\`("id", "slug", "category", "published_at", "thumbnail_id", "updated_at", "created_at", "_status") SELECT "id", "slug", "category", "published_at", "thumbnail_id", "updated_at", "created_at", "_status" FROM \`works\`;`,
  )
  ...
  await db.run(
    sql`CREATE INDEX \`_works_v_published_locale_idx\` ON \`_works_v\` (\`published_locale\`);`,
  )
  ...
  await db.run(
    sql`CREATE INDEX \`home_page_about_preview_about_preview_image_idx\` ON \`home_page\` (\`about_preview_image_id\`);`,
  )
  ...
  await db.run(
    sql`CREATE INDEX \`_home_page_v_version_about_preview_version_about_preview_idx\` ON \`_home_page_v\` (\`version_about_preview_image_id\`);`,
  )
  await db.run(
  ...
  await db.run(
    sql`CREATE INDEX \`_home_page_v_published_locale_idx\` ON \`_home_page_v\` (\`published_locale\`);`,
  )
  ...
  await db.run(
    sql`CREATE INDEX \`_about_v_published_locale_idx\` ON \`_about_v\` (\`published_locale\`);`,
  )
  ...
  await db.run(
    sql`CREATE INDEX \`_service_v_published_locale_idx\` ON \`_service_v\` (\`published_locale\`);`,
  )
  ...
  await db.run(
    sql`ALTER TABLE \`_home_page_v_version_services_items\` DROP COLUMN \`description\`;`,
  )
  ...
  await db.run(
    sql`ALTER TABLE \`_service_v_version_services_items_features\` DROP COLUMN \`text\`;`,
  )
