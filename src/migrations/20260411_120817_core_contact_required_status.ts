...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_contact_submissions\`("id", "name", "email", "phone", "message", "status", "updated_at", "created_at") SELECT "id", "name", "email", "phone", "message", "status", "updated_at", "created_at" FROM \`contact_submissions\`;`)
