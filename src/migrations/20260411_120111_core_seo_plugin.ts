...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_news\`("id", "title", "slug", "published_at", "category", "thumbnail_id", "body", "updated_at", "created_at", "_status") SELECT "id", "title", "slug", "published_at", "category", "thumbnail_id", "body", "updated_at", "created_at", "_status" FROM \`news\`;`)
