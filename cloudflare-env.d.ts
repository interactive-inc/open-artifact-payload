/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.wrangler-types.jsonc --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 2cc206c644ff717748568fcd5d342d0c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "TURNSTILE_SECRET_KEY" | "SUPPORT_EMAIL" | "RESEND_API_KEY" | "CONTACT_NOTIFICATION_EMAIL" | "CONTACT_NOTIFICATION_FROM" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY">> {}
}
