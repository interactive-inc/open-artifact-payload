/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.wrangler-types.jsonc --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 6f2e8f12e530ddcc3bfee1324917ebc9)
...
interface __BaseEnv_CloudflareEnv {
	...
	TURNSTILE_ALLOW_INSECURE_LOCAL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "TURNSTILE_SECRET_KEY" | "TURNSTILE_ALLOW_INSECURE_LOCAL" | "SUPPORT_EMAIL" | "RESEND_API_KEY" | "EMAIL_FROM" | "CONTACT_NOTIFICATION_EMAIL" | "CONTACT_NOTIFICATION_FROM" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY">> {}
}
